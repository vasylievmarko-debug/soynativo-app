...
Surfaced during SDK 50 → 51 migration but not related. Existed before and were not caught because previous type-check runs may not have been done.

**`apps/mobile/src/shared/ui/atoms/__tests__/Button.test.tsx:9:33`**
...
**When:** Low priority — only affects test file, not runtime.
**Why later:** Doesn't block Metro bundler or app functionality.
